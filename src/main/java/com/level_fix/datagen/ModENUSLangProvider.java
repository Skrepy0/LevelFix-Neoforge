...
public class ModENUSLangProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("level_fix.configuration.show_both","Show both Roman and Arabic numerals");
        add("level_fix.configuration.show_both.tooltip","When enabled, displays the corresponding Arabic numeral next to the Roman numeral.");
